<?php
	...
	define('WUP_PLUGIN_VERSION', '1.0.7');
	...
	if( !defined('LOADING_UPDATES_MANAGER_AS_ADDON') ) {
		require_once(WUP_PLUGIN_DIR . '/libs/factory/core/includes/check-compatibility.php');
		require_once(WUP_PLUGIN_DIR . '/libs/factory/clearfy/includes/check-clearfy-compatibility.php');
	}
	...
	$plugin_info = array(
		...
		'plugin_version' => WUP_PLUGIN_VERSION,
	...
	$compatibility = new Wbcr_FactoryClearfy000_Compatibility(array_merge($plugin_info, array(
		'plugin_already_activate' => defined('WUP_PLUGIN_ACTIVE'),
		'plugin_as_component' => defined('LOADING_UPDATES_MANAGER_AS_ADDON'),
		'plugin_dir' => WUP_PLUGIN_DIR,
		'plugin_base' => WUP_PLUGIN_BASE,
		'plugin_url' => WUP_PLUGIN_URL,
	...
	if( !defined('LOADING_UPDATES_MANAGER_AS_ADDON') ) {
		new WUP_Plugin(__FILE__, $plugin_info);
	}
